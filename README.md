...
- [Approach to answering CKAD questions](./01-ckad-approach.md)
- [Modifying the shell for the CKAD exam](./02-ckad-modifications.md)
- [Kubernetes short names](./05-api-resources.md)
- [Just enough vi](./06-just-enough-vi.md)

## Reference

- [tmux in the CKAD shell](./03-ckad-tmux.md) — reference only; the new exam platform supports multiple shells, making `tmux` redundant.
- [Vivaldi as a backup browser](./04-ckad-vivaldi.md) — reference only; Firefox is the primary browser on the new exam platform.
